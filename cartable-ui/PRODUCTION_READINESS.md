...
#### ⚠️ آسیب‌پذیری کتابخانه xlsx
- **وضعیت**: آسیب‌پذیری High (Prototype Pollution و ReDoS)
- **توصیه**:
  - در صورت امکان، به جای xlsx از کتابخانه `exceljs` استفاده کنید
  - یا منتظر به‌روزرسانی کتابخانه xlsx بمانید
  - در حال حاضر، از ورودی‌های کاربر در export استفاده نکنید
...
سپس export utilities را به‌روزرسانی کنید.
